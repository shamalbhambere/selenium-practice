...
@CucumberOptions(
		features= {"src/test/java/features/tagging.feature"},//used for write feature file path
...
public class TestRunner {
 ...
 //OR: tags= {"@Smoke  , @Regression"}---either smoke or regression
 //AND: tags= {"@Smoke"  , "@Regression"}--- smoke and regression
 //Neither: tags= {"~@Smoke"  , "@Regression"}--- not smoke, only regression
